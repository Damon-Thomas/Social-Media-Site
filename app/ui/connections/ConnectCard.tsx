...
export default function ConnectCard({ user }: { user: ConnectUser }) {
  ...
  return (
    <div className="flex flex-col items-center p-2 border-1 rounded h-48 w-48 overflow-hidden">
      {mounted ? (
        <Image
      ...
      <div className="flex items-center justify-center">
        <p className="text-[var(--dmono)] h-8 font-bold overflow-hidden text-ellipsis whitespace-nowrap">
          {user.name}
        </p>
      </div>
      <div className="grid grid-cols-2 grid-rows-2 gap-2 w-full mt-2 items-center">
