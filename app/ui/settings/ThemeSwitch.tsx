...
import moon from "@public/moonPrimary.svg";
...
export default function ThemeSwitch() {
  ...
  return (
    <button
      className={`w-20 rounded-l-3xl relative rounded-r-3xl bg-[var(--dmono-30)] text-[var(--rdmono)] h-11 rounded outline-2 outline-[var(--dmono)] no-scale overflow-hidden`}
      onClick={handleThemeChange}
    >
      <div
        className={`h-10 w-10 absolute top-0.5 transition-all duration-300 ease ${
          theme === "dark" ? "left-0.5" : "left-[calc(100%-2.6rem)]"
